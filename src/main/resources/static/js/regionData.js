...
document.addEventListener("DOMContentLoaded", function () {
    const selectedSido = document.getElementById("sidoSelected")?.value;
    const selectedGugun = document.getElementById("gugunSelected")?.value;
    const selectedDong = document.getElementById("dongSelected")?.value;

    if (selectedSido) {
        document.getElementById("sidoSelect").value = selectedSido;
        updateGugun(selectedSido, () => {
            if (selectedGugun) {
                document.getElementById("gugunSelect").value = selectedGugun;
                updateDong(selectedSido, selectedGugun, () => {
                    if (selectedDong) {
    ...
    function updateGugun() {
        ...
        if (regionData[sido]) {
            for (const gugun in regionData[sido]) {
                const option = new Option(gugun, gugun);
    ...
    if (sido && gugun && dong) {
        const fullRegion = `${sido} ${gugun} ${dong}`;
        document.getElementById("region").value = fullRegion;
        document.getElementById("regionDisplay").value = fullRegion;
